...
INSERT INTO "HEALTH_OBSERVATION" (HO_PATIENT, HO_OBSERVATIONTYPE, HO_VALUE, HO_OBSERVEDDATETIME, HO_RECORDEDDATETIME) VALUES ('2', '18', '180', TO_DATE('2016-10-10 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2016-10-11 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
--Following statement should alert trigger and add row to alert table
INSERT INTO "HEALTH_OBSERVATION" (HO_PATIENT, HO_OBSERVATIONTYPE, HO_VALUE, HO_OBSERVEDDATETIME, HO_RECORDEDDATETIME) VALUES ('2', '18', '195', TO_DATE('2016-10-17 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2016-10-17 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
